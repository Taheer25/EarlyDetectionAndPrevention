"""early_detection_and_prevention URL Configuration
...
from early_detection_and_prevention import settings
...
urlpatterns = [
    ...
    url(r'^Detect_Malicious_User/$', remoteuser.Detect_Malicious_User, name="Detect_Malicious_User"),
    ...
    url(r'^View_Detected_Malicious_User_Type_Ratio/$', serviceprovider.View_Detected_Malicious_User_Type_Ratio, name="View_Detected_Malicious_User_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Detected_Malicious_User_Details/$', serviceprovider.View_Detected_Malicious_User_Details, name="View_Detected_Malicious_User_Details"),
