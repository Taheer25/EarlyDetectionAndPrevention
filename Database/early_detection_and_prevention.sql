...
--
-- Host: localhost
-- Generation Time: Jan 20, 2025 at 12:11 PM
...
--
-- Database: `early_detection_and_prevention`
--
CREATE DATABASE IF NOT EXISTS `early_detection_and_prevention` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `early_detection_and_prevention`;
...
('haj6301g8koqb6tdp6i3mw29we1hzyft', 'eyJ1c2VyaWQiOjJ9:1r15Hf:si_o-xQZZKq50wPVj-OZSJQUaNNaSMFO52Es_6oai-c', '2023-11-23 13:41:23.923783'),
...
('rlpqqqxmtgcf0nwxvk8n4uum57y7391x', 'eyJ1c2VyaWQiOjR9:1tJW6E:FyTCnTjYNMyT82VSktudR1H2Szus43wsvQgWjB_WOEU', '2024-12-20 11:02:18.600433'),
...
('zxnkrpbavgz66yktvzgyktri8c8l7eqx', 'eyJ1c2VyaWQiOjF9:1r14QG:Yocj_r67JVUocoorfHkDx9Gs896S-K3mdAUZZqCuayc', '2023-11-23 12:46:12.202537');
...
(3, 'Mahesh', 'Mahesh123@gmail.com', 'Mahesh', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,8th Cross,Malleshwaram', 'Male'),
(4, 'Manjunath', 'tmksmanju14@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#809,8th Cross,Malleshwaram', 'Male');
...
(22, 'Recurrent Neural Networks (RNN)', '52.09125475285171'),
(23, 'SVM', '53.99239543726235'),
(24, 'Logistic Regression', '52.851711026615966'),
(25, 'Random Forest Classifier', '53.99239543726235'),
(26, 'KNeighborsClassifier', '53.2319391634981');
...
(20, 'Normal User', '57.14285714285714'),
(21, 'Malicious User', '42.857142857142854');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_detect_malicious_user`
--

CREATE TABLE IF NOT EXISTS `remote_user_detect_malicious_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `Community` varchar(3000) NOT NULL,
  `Followers` varchar(3000) NOT NULL,
  `Retweets` varchar(3000) NOT NULL,
  `Likes` varchar(3000) NOT NULL,
  `Unlikes` varchar(3000) NOT NULL,
  `Prediction` varchar(3000) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=12 ;

--
-- Dumping data for table `remote_user_detect_malicious_user`
--

INSERT INTO `remote_user_detect_malicious_user` (`id`, `Fid`, `Age`, `Gender`, `Street`, `City`, `Latitude`, `Longitude`, `Community`, `Followers`, `Retweets`, `Likes`, `Unlikes`, `Prediction`) VALUES
(5, '10.42.0.151-52.84.134.158-38846-443-6', '70', 'Female', '22051 Fraser Highway', 'Langley', '49.092813', '-122.612079', 'Education', '198', '60', '91', '17', 'Normal User'),
(6, '10.42.0.211-69.147.82.60-54184-443-6', '37', 'Male', '11-32700 George Ferguson Way', 'Abbotsford', '49.055266', '-122.318479', 'Business', '222', '55', '197', '10', 'Malicious User'),
(7, '10.42.0.151-64.71.142.95-49935-443-6', '65', 'Female', '11-32700 George Ferguson Way', 'Abbotsford', '49.055266', '-122.318479', 'Neighbourhood', '38', '85', '89', '10', 'Malicious User'),
(8, '172.217.10.97-10.42.0.151-443-55777-6', '36', 'Male', '1100-13401 108th Avenue', 'Surrey', '49.199092', '-122.850254', 'Sports', '342', '65', '63', '10', 'Normal User'),
(9, '203.130.53.126-10.42.0.211-80-42837-6', '67', 'Male', '550 Carmi Avenue', 'Penticton', '49.482657', '-119.578687', 'Education', '787', '68', '95', '10', 'Malicious User'),
(10, '198.11.132.178-10.42.0.211-443-51796-6', '40', 'Male', '98 Ridgewood Drive', 'Princeton', '49.453436', '-120.526235', 'Sports', '145', '83', '61', '21', 'Normal User'),
(11, '10.42.0.42-23.194.181.192-41213-443-6', '70', 'Female', '851 16th Street NE', 'Salmon Arm', '50.705422', '-119.268678', 'Sports', '514', '71', '51', '22', 'Normal User');
